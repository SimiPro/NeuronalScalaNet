...
object ImageApplication {
  ...
  val reader:MNISTReader = new MNISTReader("/Users/simipro/MachineLearning/t10k-labels.idx1-ubyte","/Users/simipro/MachineLearning/t10k-images.idx3-ubyte ")
  reader.register(I => {
  ...
  reader.read()
    ...
    val net:Net = new NetBuilder()
      ...
      .addHiddenLayers(new HiddenLayerBuilder().setUnits(300))
